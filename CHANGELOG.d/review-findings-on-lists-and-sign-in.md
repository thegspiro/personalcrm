...
*Schema: `20260901120000_add_login_attempt_throttle`*
...
- **Repeated wrong sign-in attempts now back off.** Five at full speed, then a
  ...
  last week do not throttle the first attempt today. The client half of the key
  is only as trustworthy as the proxy in front of the app; what that buys and
  what it does not is written out in `docs/privacy.md`.
