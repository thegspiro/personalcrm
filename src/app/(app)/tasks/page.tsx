    ...
    <div className="grid grid-cols-[minmax(0,1fr)] gap-4">
      ...
      >
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            People whose keep-in-touch cadence is due or coming due.
          </p>
        </div>
        {people.length === 0 ? (
          <EmptyState
            ...
            title="Nobody is due"
            description="People appear here as their keep-in-touch cadence comes due."
          />
        ) : (
              ...
              <li key={person.id}>
                ...
                >
                  ...
                  <span
                    className={cn(
                      "shrink-0 text-xs",
                      person.daysUntilDue <= 0 ? "text-destructive" : "text-muted-foreground",
                    )}
                  >
                    {dueLabel(person.daysUntilDue)}
                  </span>
                </Link>
              </li>
            ))}
